/* File generated from [sample-programs/test/test4.c] by PICCO Wed Jul 20 11:13:50 2022
 */
...
mpz_t a;
 ...
 // exit ast_priv_decl_show: DECLARATOR
   /* size set3: 24, 24 */
__s->smc_set(1780, a, 11, 24, "int", -1);
...
mpz_t b;
 ...
 // exit ast_priv_decl_show: DECLARATOR
   /* size set3: 24, 24 */
__s->smc_set(3456, b, 12, 24, "int", -1);
// exit ast_priv_decl_show: DINIT
...
mpz_t c;
 ...
 // exit ast_priv_decl_show: DECLARATOR
   /* size set3: 24, 24 */
__s->smc_set(2345, c, 12, 24, "int", -1);
// exit ast_priv_decl_show: DINIT
// exit ast_priv_decl_show: DLIST
...
i = 0;
  ...
  {
    {
      __s->smc_add(a, b, _picco_tmp1, 24, 24, 25, "int", -1);
 /*a7: 24, 24, 24 */
       __s->smc_shr(_picco_tmp1, 1, _picco_tmp1, 24, 1, 24, "int", -1);
 /*a7: 24, -1, 24 */
       __s->smc_set(_picco_tmp1, x, 24, 24, "int", -1) /*a4: 24, 32 */ ;

      __s->smc_gt(x, c, _picco_tmp1, 24, 24, 1, "int", -1);
 /*a7: 32, 24, 1 */
