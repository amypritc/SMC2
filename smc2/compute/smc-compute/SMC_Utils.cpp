...
*     SMC Addition
*/
// smc_add_priv_priv_int --> priv int + priv int
...
// smc_add_priv_pub_int --> priv int + pub int
void SMC_Utils::smc_add(mpz_t a, int b, mpz_t result, int alen, int blen, int resultlen, std::string type, int threadID){
   ...
   // call to smc_add_priv_priv_int
	smc_add(a, btmp, result, alen, blen, resultlen, type, threadID); 
	mpz_clear(btmp);  
}

// smc_add_pub_priv_int --> pub int + priv int
...
// smc_add_priv_pub_float --> priv float + pub float
void SMC_Utils::smc_add(mpz_t* a, float b, mpz_t* result, int alen_sig, int alen_exp, int blen_sig, int blen_exp, int resultlen_sig, int resultlen_exp, std::string type, int threadID)
{
   ...
   // call to smc_add_priv_priv_float
...
// smc_add_pub_priv_float --> pub float + priv float
...
// smc_add_priv_priv_float --> priv float + priv float
...
//batch version of smc_add (over arrays)
// smc_batch_add_pub_priv_int --> pub int* + priv int*
...
// smc_batch_add_priv_priv_int --> priv int* + priv int*
...
// smc_batch_add_priv_pub_float --> priv float* + pub float*
...
// smc_batch_add_priv_priv_float --> priv float* + priv float*
