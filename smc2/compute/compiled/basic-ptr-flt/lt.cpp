/* File generated from [sample-programs/basic-ptr-flt/lt.c] by PICCO Mon Feb  8 17:41:11 2021
 */
...
mpz_t* a; 
  ...
  __s->smc_lt(a, 0.0, _picco_tmp1, 32, 9, -1, -1, 1, "float", -1);
  __s->smc_set(_picco_tmp1, x, 1, 32, "int", -1);

  __s->smc_lt(a, 1.5, _picco_tmp1, 32, 9, -1, -1, 1, "float", -1);
  __s->smc_set(_picco_tmp1, x1, 1, 32, "int", -1);

  __s->smc_lt(a, 2.7, _picco_tmp1, 32, 9, -1, -1, 1, "float", -1);
  __s->smc_set(_picco_tmp1, x2, 1, 32, "int", -1);

  __s->smc_lt(9.5, b, _picco_tmp1, -1, -1, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, y, 1, 32, "int", -1);

  __s->smc_lt(0.125, b, _picco_tmp1, -1, -1, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, y1, 1, 32, "int", -1);

  __s->smc_lt(0.025, b, _picco_tmp1, -1, -1, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, y2, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_lt(_picco_priv_ftmp1, a, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, v, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_lt(_picco_priv_ftmp1, b1, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, v1, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_lt(_picco_priv_ftmp1, b, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, v2, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_lt(b, _picco_priv_ftmp2, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
...
__s->smc_lt(a, _picco_priv_ftmp2, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, w2, 1, 32, "int", -1);

  __s->smc_lt(b, a, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, z, 1, 32, "int", -1);

  __s->smc_lt(b, b1, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, z1, 1, 32, "int", -1);

  __s->smc_lt(a, b, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
