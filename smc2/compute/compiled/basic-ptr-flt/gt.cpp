/* File generated from [sample-programs/basic-ptr-flt/gt.c] by PICCO Mon Feb  8 17:41:11 2021
 */
...
__s->smc_gt(_picco_priv_ftmp1, a, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, v, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_gt(_picco_priv_ftmp1, b1, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, v1, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_gt(_picco_priv_ftmp1, b, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, v2, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_gt(b, _picco_priv_ftmp2, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
...
__s->smc_gt(a, _picco_priv_ftmp2, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
