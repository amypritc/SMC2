/* File generated from [sample-programs/basic-ptr-flt/ptr-neq.c] by PICCO Mon Feb  8 17:41:13 2021
 */
...
mpz_t* a; 
  ...
  __s->smc_neq(pb, pa, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
  __s->smc_set(_picco_tmp1, x, 1, 32, "int", -1);

  __s->smc_neq(pb, pb1, _picco_tmp1, 32, 9, 32, 9, 1, "float", -1);
