/* File generated from [sample-programs/priv-cond-if-neq-flt/if-else-nest-ff.c] by PICCO Mon Feb  8 17:41:27 2021
 */
...
{
      {
        ...
        __s->smc_neq(b, 0.0, _picco_tmp2, 32, 9, -1, -1, 1, "float", -1);
          {
...
__s->smc_set(_picco_priv_float_c_2_else, c, 32, 9, 32, 9, "float", -1);
          ...
          {
            {
                            __s->smc_set(3.4, c, -1, -1, 32, 9, "float", -1);
            }
          }
