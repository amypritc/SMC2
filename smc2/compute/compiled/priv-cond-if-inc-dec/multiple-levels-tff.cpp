/* File generated from [sample-programs/priv-cond-if-inc-dec/multiple-levels-tff.c] by PICCO Mon Feb 22 20:48:18 2021
 */
...
{
      {
        ...
        __s->smc_lt(f, e, _picco_tmp2, 32, 32, 1, "int", -1);
          {
          ...
          {
            {
              ...
              __s->smc_lt(f, d, _picco_tmp3, 32, 32, 1, "int", -1);
                {
