/* File generated from [sample-programs/priv-cond-if-inc-dec/multiple-levels-ff.c] by PICCO Mon Feb 22 20:48:18 2021
 */
    ...
    {
      {
        ...
        __s->smc_gt(b, d, _picco_tmp2, 32, 32, 1, "int", -1);
          {
mpz_t _picco_condtmp2;
mpz_init(_picco_condtmp2);
__s->smc_sub(1, _picco_tmp2, _picco_condtmp2, 1, 1, 1, "int", -1);
