/* File generated from [sample-programs/priv-cond-if-neq/if-else-nest-ft.c] by PICCO Mon Feb  8 17:41:14 2021
 */
...
{
      {
        ...
        __s->smc_neq(b, 0, _picco_tmp2, 32, -1, 1, "int", -1);
          {
