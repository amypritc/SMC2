/* File generated from [sample-programs/basic-ops/div.c] by PICCO Mon Feb  8 17:40:54 2021
 */
...
int  __original_main(int _argc_ignored, char **_argv_ignored)
{
 ...
 mpz_t a;
  ...
  __s->smc_div(a, 3, _picco_tmp1, 32, -1, 32, "int", -1);
  __s->smc_set(_picco_tmp1, x, 32, 32, "int", -1);

  __s->smc_div(14, b, _picco_tmp1, -1, 32, 32, "int", -1);
  __s->smc_set(_picco_tmp1, y, 32, 32, "int", -1);

  __s->smc_div(a, b, _picco_tmp1, 32, 32, 32, "int", -1);
