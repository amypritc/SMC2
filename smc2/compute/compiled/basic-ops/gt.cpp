/* File generated from [sample-programs/basic-ops/gt.c] by PICCO Mon Feb  8 17:40:54 2021
 */
...
int  __original_main(int _argc_ignored, char **_argv_ignored)
{
 ...
 mpz_t a;
  ...
  __s->smc_gt(a, 0, _picco_tmp1, 32, -1, 1, "int", -1);
  __s->smc_set(_picco_tmp1, x, 1, 32, "int", -1);

  __s->smc_gt(a, 2, _picco_tmp1, 32, -1, 1, "int", -1);
  __s->smc_set(_picco_tmp1, x1, 1, 32, "int", -1);

  __s->smc_gt(a, 5, _picco_tmp1, 32, -1, 1, "int", -1);
  __s->smc_set(_picco_tmp1, x2, 1, 32, "int", -1);

  __s->smc_gt(9, b, _picco_tmp1, -1, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, y, 1, 32, "int", -1);

  __s->smc_gt(7, b, _picco_tmp1, -1, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, y1, 1, 32, "int", -1);

  __s->smc_gt(1, b, _picco_tmp1, -1, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, y2, 1, 32, "int", -1);

  __s->smc_gt(b, a, _picco_tmp1, 32, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, z, 1, 32, "int", -1);

  __s->smc_gt(b, b1, _picco_tmp1, 32, 32, 1, "int", -1);
