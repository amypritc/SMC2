/* File generated from [sample-programs/basic-ptr/div.c] by PICCO Mon Feb  8 17:41:05 2021
 */
...
__s->smc_div(_picco_priv_tmp1, b, _picco_tmp1, 32, 32, 32, "int", -1);
  __s->smc_set(_picco_tmp1, v, 32, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_div(b, _picco_priv_tmp2, _picco_tmp1, 32, 32, 32, "int", -1);
  __s->smc_set(_picco_tmp1, w, 32, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_div(_picco_priv_tmp1, 3, _picco_tmp1, 32, -1, 32, "int", -1);
  __s->smc_set(_picco_tmp1, x, 32, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_div(14, _picco_priv_tmp2, _picco_tmp1, -1, 32, 32, "int", -1);
  __s->smc_set(_picco_tmp1, y, 32, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp1, 1, NULL, "int", -1);
  __s->smc_dereference_read_ptr(pb, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_div(_picco_priv_tmp1, _picco_priv_tmp2, _picco_tmp1, 32, 32, 32, "int", -1);
...
__s = new SMC_Utils(atoi(argv[1]), argv[2], argv[3], atoi(argv[4]), atoi(argv[5]), IO_files, 3, 1, 121, "1329227995784915872903807060280345027", 1);
