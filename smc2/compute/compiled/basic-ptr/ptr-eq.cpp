/* File generated from [sample-programs/basic-ptr/ptr-eq.c] by PICCO Mon Feb  8 17:41:13 2021
 */
...
mpz_t a;
  ...
  __s->smc_eqeq(pb, pa, _picco_tmp1, 32, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, x, 1, 32, "int", -1);

  __s->smc_eqeq(pb, pb1, _picco_tmp1, 32, 32, 1, "int", -1);
