/* File generated from [sample-programs/basic-ptr/eqeq.c] by PICCO Mon Feb  8 17:41:05 2021
 */
...
__s->smc_eqeq(_picco_priv_tmp1, 0, _picco_tmp1, 32, -1, 1, "int", -1);
  __s->smc_set(_picco_tmp1, x, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_eqeq(_picco_priv_tmp1, 2, _picco_tmp1, 32, -1, 1, "int", -1);
  __s->smc_set(_picco_tmp1, x1, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_eqeq(_picco_priv_tmp1, 5, _picco_tmp1, 32, -1, 1, "int", -1);
  __s->smc_set(_picco_tmp1, x2, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_eqeq(9, _picco_priv_tmp2, _picco_tmp1, -1, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, y, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_eqeq(7, _picco_priv_tmp2, _picco_tmp1, -1, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, y1, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_eqeq(1, _picco_priv_tmp2, _picco_tmp1, -1, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, y2, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_eqeq(_picco_priv_tmp1, a, _picco_tmp1, 32, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, v, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_eqeq(_picco_priv_tmp1, b1, _picco_tmp1, 32, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, v1, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp1, 1, NULL, "int", -1);
__s->smc_eqeq(_picco_priv_tmp1, b, _picco_tmp1, 32, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, v2, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pa, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_eqeq(b, _picco_priv_tmp2, _picco_tmp1, 32, 32, 1, "int", -1);
...
__s->smc_eqeq(b, _picco_priv_tmp2, _picco_tmp1, 32, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, w1, 1, 32, "int", -1);
    ...
    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_eqeq(a, _picco_priv_tmp2, _picco_tmp1, 32, 32, 1, "int", -1);
  __s->smc_set(_picco_tmp1, w2, 1, 32, "int", -1);

    __s->smc_dereference_read_ptr(pb, _picco_priv_tmp1, 1, NULL, "int", -1);
  __s->smc_dereference_read_ptr(pa, _picco_priv_tmp2, 1, NULL, "int", -1);
__s->smc_eqeq(_picco_priv_tmp1, _picco_priv_tmp2, _picco_tmp1, 32, 32, 1, "int", -1);
