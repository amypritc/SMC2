...
/* Turn on (1) or off (0) debugging messages (option -d) */
int debug_msg;
/* Turn on (1) or off (0) optimal variable sizing pass (option -varsize) */
int opt_var_size_pass;
/* Max variable sizes defined here so it's possible to add a options or a config file to let the user define these  */
int MAX_PUB_INT_SIZE;        /* Maximum size of a public integer variable */
int MAX_PRIV_INT_SIZE;       /* Maximum size of a private integer variable */
